use anyhow::Result;
use crate::obfuscation::{ObfuscationLevel, ObfuscationError};
use crate::obfuscation::{rename_locals, add_dead_code, obfuscate_control_flow, split_large_functions, virtualize_functions};
