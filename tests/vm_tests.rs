use ruswacipher::obfuscation::virtualization::{virtualize_functions, find_virtualizable_functions};
...
fn has_code_section(module: &WasmModule) -> bool {
    module.sections.iter().any(|section| section.section_type == SectionType::Code)
}
